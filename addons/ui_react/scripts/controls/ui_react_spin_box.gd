...
func _trigger_animations(trigger_type: UiAnimTarget.Trigger) -> void:
	...
	UiReactFeedbackTargetHelper.run_audio_feedback(self, "UiReactSpinBox", audio_targets, trigger_type)
	UiReactFeedbackTargetHelper.run_haptic_feedback(self, "UiReactSpinBox", haptic_targets, trigger_type)
