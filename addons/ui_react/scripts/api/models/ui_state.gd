...
## Instantiate a concrete subclass ([UiBoolState], [UiIntState], [UiFloatState], [UiStringState], [UiArrayState], [UiTransactionalState], or a **subclass** of [UiComputedStringState] / [UiComputedBoolState]) only.
