...
## For inspector-driven wiring, use [UiReactButton] / [UiReactTextureButton] with [member UiReactButton.transactional_host] ([UiReactTransactionalHostBinding]), [UiTransactionalScreenConfig], and [UiReactTransactionalSession].
