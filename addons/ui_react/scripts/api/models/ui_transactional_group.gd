...
## For inspector-driven wiring, prefer [UiReactButton] / [UiReactTextureButton] with [member UiReactButton.transactional_host] ([UiReactTransactionalHostBinding]), [UiTransactionalScreenConfig], and [UiReactTransactionalSession]; [UiReactTransactionalActions] remains for path-based Apply/Cancel (deprecated).
